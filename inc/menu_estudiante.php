        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
          ...
          <div class="offcanvas-body">
            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="../app/home_estudiante.php">Inicio</a>
              </li>
              ...
              <li class="nav-item dropdown">
                ...
                <li><a class="dropdown-item" href="../app/Perfil_estudiante.php">Perfil</a></li>
                  <li><a class="dropdown-item" href="../app/notas_estudiante.php">Calificaciones</a></li>
                  <li>
